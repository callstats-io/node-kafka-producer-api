...
var producerClient = producerKafkaModule.getProducerClient("test-rs.callstats.io",9092,"topicCluster",0);
...
//var producerClient2 = producerKafkaModule.getProducerClient("test-rs.callstats.io",9092,"topicCluster",1);
